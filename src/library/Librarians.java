        ...
        while (true) {
            ...
            if (option1 == 1) {
                      ...
                      break;
                            ...
                            if (isblocked == true) {
                                ...
                                if (choice == 'y') {
                                    ...
                                    add_user_orderlist(userID, book, bookID);
                                }
                ...
                while (bookID == -1) {
                    ...
                    if (bookID == -1) {
                        System.out.println("THIS BOOK IS NOT REGISTERED IN THE SYSTEM! PLEASE ENTER BOOK NAME:");
                        bookName = input.next();
                    }
                }

                show_orderlist(reader, admin, book, bookID);
                ...
                if (option1 == 1) {
                    ...
                    remove_user_orderlist(userID, book, bookID);
                }
            } else if (option1 == 6) {
